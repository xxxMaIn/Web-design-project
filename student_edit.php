	...
	$err = array();
		if(isset($_POST) && array_key_exists('Update',$_POST)){
			...
			if(empty($err)) {
				...
				$sql_insert = "UPDATE ".DB_PREFIX."system_users SET `ID_number`='$studentID', `first_name`='$data[fname]', `middle_name` = '$data[mname]', `last_name` = '$data[lname]', `suffix` = '$data[suffix]', `email` = '$useremail', `scholarship` = '$data[scholarship]', `college` = '$data[college]', `birthdate` = '$dob', `gender` = '$data[gender]', `password` = '$sha1pass', `question` = '$data[question]', `answer` = '$data[answer]' WHERE `user_ID` = $recordID";
				mysqli_query($link, $sql_insert) or die("Update Failed:" . mysqli_error());

				$_SESSION['msg'] = "Record has been updated.";
				header("Location: student_edit.php?refer=".$studentID);
				exit();
			} // No Error
			else{
				$_SESSION['errors'] = $err;
				header("Location: student_edit.php?refer=".$_SESSION['oldID']);
				exit();
			}
		} // Submitted
								...
								?>
									<div>
										<div class="6u 12u$(medium)" style="text-align:left;float:left;width: 78%;">
											<h3>Basic Details</h3>
											<dl class="alt">
											<form action="student_edit.php" method="post" name="RegForm" id="RegForm" >
												...
												<table>
													...
													<tr>
														...
														<td> 
															...
															<select name="suffix" id="suffix" style="float:left;width:100px;height:29px" >
													...
													<tr>
														<td>Birthdate</td>
														<td>
															<select id="mdob" name="mdob" style="width:200px;float:left;margin-right:5px;height:30px">
																<?php
															...
															<select id="ddob" name="ddob" style="width:90px;float:left;margin-right:5px;height:30px">
																<?php
															...
															<select id="ydob" name="ydob" style="width:90px;float:left;margin-right:5px;height:30px">
													...
													<tr>
														<td>Scholarship</td>
														<td>
															<select name="scholarship" id="scholarship" style="float:left;margin-right:5px;height:30px">
													...
													<tr>
														<td>College</td>
														<td>
															<select name="college" id="college" style="float:left;margin-right:5px;height:30px">
