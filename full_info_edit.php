										...
										<div class="6u 12u$(medium)" style="text-align:left;float:left;width: 82%;">
											...
											<form action="full_info_edit.php" method="post" name="RegForm" id="RegForm" >
												...
												<table>
													<tr>
														<td>ID No.</td>
														<td><input type="text" <?php IF(Student()): echo 'readonly'; ENDIF; ?> name="student_ID" id="student_ID" placeholder="Student ID" style="float:left;width:178px;height:30px" value="<?php echo $profile['ID_number']; ?>"/></td>
													</tr>
													<tr>
														<td>Name</td>
														<td> 
